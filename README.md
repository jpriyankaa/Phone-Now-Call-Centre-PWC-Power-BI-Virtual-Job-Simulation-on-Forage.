# PwC Switzerland Power BI Job Simulation - Phone Now – August 2024
...
The images provided in the dashboard allow us to focus on key data points and metrics:
...
1. **Dashboard Creation for PhoneNow**
    - **Data Preparation:** Data from PhoneNow’s customer satisfaction surveys, call metrics, and agent performance reports were collected and cleansed to ensure accuracy. KPIs were identified to provide a comprehensive view of customer retention and agent performance.
    - **Dashboard Development:** Using Power BI, interactive and user-friendly dashboards were created. These dashboards included key visual elements, such as:
        ...
        - **Customer Risk Analysis:** Provided insights into customers’ risk of churn, segmented by Internet services like DSL, Fiber Optic, and contract types. For instance, 7043 customers were analyzed to determine risk levels.
